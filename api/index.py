...
knn_model = joblib.load(MODEL_DIR / "recommender_knn.pkl")
...
def read_root():
    ...
    return {"message": "AutoBite API is running! Visit /docs for API documentation."}
...
def health_check():
    ...
    return {"status": "ok", "service": "AutoBite API"}
